...
public class P2PSimulation {
    ...
    public P2PSimulation(double Us, double lambda, double lambda_p) throws IOException{
        ...
        writer = new PrintWriter("Decline-Most-Popular-Us-2-lambda-4.txt", "UTF-8");
    ...
    public int Run() throws IOException{
        ...
        for(int t = 0; t< Ticks; t++){
            double peerContactTime = expRand(NumberOfPeers *lambda_p);
...
//        int pktIdx = seedDepriveMostPopularChunk(dstPeer);
        assertMetaVariables();
...
//            rarestPktIdx = usefulPktIdx.get(0);
    ...
    private int seedDepriveMostPopularChunk(Peer dstPeer){
        /*
        src contains all elements
        */
        int [] dst = dstPeer.Buffer;
